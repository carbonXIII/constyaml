...
export module constyaml;

import constyaml.dict;
import constyaml.list;

namespace constyaml::yaml::detail {
  ...
  constexpr auto parse_flat(const std::string_view body) {
  ...
  constexpr auto parse_unfold(const std::string_view body) {
...
export namespace constyaml {
  namespace yaml {
    constexpr auto parse(auto callable) {
